...
function setup() {
 ...
 console.log(message)
  ...
  // make gameover and restart image smaller
  gameOver.scale = 0.5;
  restart.scale = 0.5;
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if(obstaclesGroup.isTouching(trex)){
     ...
     // make gameover and restart buttons visible 
...
function spawnClouds() {
  ...
  if (camera.position.x % 100 === 0) {
    var cloud = createSprite(camera.position.x + 900,120,40,10);
